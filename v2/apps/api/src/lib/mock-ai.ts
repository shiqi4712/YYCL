...
export function buildMockReply(input: AiReplyInput) {
  ...
  if (input.phase === 'close') {
    return selectReply(
      materialSent
        ? ['我看到了，这样就清楚多了。那就给孩子报名吧，把付款方式和后续安排发我一下。', '这个资料挺直观的，我心里踏实了。课程我们报，麻烦把报名链接发我。']
        : ['这样解释我就清楚多了，那就给孩子报名吧，付款和后续安排发我一下。', '好，这个课程我们报名，麻烦把付款方式发我。'],
      teacherMessage
    )
  }
  ...
  return selectReply(
    input.emotionState === '防备'
      ? [
          '嗯，我听明白了。像我们家这种情况，课堂上一般会怎么带呢？',
          '那如果实际体验的时候孩子跟不上，老师通常会怎么调整呀？',
          '我主要还是想知道，具体放到孩子身上会怎么安排。',
        ]
      : [
          '这个方向我大概明白了，放到我家孩子身上会怎么安排？',
          '听起来可以，那实际体验时主要会观察哪些表现呢？',
          '那上课以后，老师会怎么跟我们反馈孩子的情况？',
        ],
    teacherMessage
  )
}
